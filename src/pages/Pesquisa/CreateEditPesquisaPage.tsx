...
import { CREATE_PESQUISA_MUTATION, UPDATE_PESQUISA_MUTATION } from '../../graphql/Pesquisa/mutations';
import { GET_PESQUISA_BY_ID } from '../../graphql/Pesquisa/queries';
import { GET_CATEGORIAS_OPTIONS } from '../../graphql/Categoria/queries';
import type {
  CreatePesquisaData,
  CreatePesquisaVars,
  GetPesquisaByIdData,
